...
# ------------------------------------------------------------
# 5. 영화 10편 이상 장르의 총 관객 - 박스플롯
# ------------------------------------------------------------
st.header("5️⃣ 장르별 총 관객 분포 (10편 이상 장르만)")

major_genres = genre_counts.loc[genre_counts["count"] >= 10, "genre"]
...
st.plotly_chart(fig_box, use_container_width=True, key="genre_total_audi_boxplot")
...
# ------------------------------------------------------------
# 6. 개봉일 스크린수 vs 총 관객 (첫 주 관객 크기) - 버블 그래프
# ------------------------------------------------------------
st.header("6️⃣ 개봉일 스크린수와 총 관객의 관계 (첫 주 관객 크기)")
...
st.plotly_chart(fig_bubble, use_container_width=True, key="scrn_vs_audi_bubble")
...
st.plotly_chart(fig_sunburst, use_container_width=True, key="nation_genre_sunburst")
...
# ------------------------------------------------------------
# 8. 나만의 질문 - 10위권 유지 일수 vs 총 관객
# ------------------------------------------------------------
my_question = "장르별로 개봉 시기가 다를까? 그렇다면 어느 달에 영화가 많이 개봉했을까?"

st.header("8️⃣ 나만의 질문")
...
fig_my.update_traces(
    hovertemplate="%{hovertext}<br>10위권 유지 일수: %{x}일<br>총 관객: %{y:,}명<extra></extra>",
)
...
st.plotly_chart(fig_my, use_container_width=True, key="my_question_scatter")
